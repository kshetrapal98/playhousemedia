...
function ForgotPasswordPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setSuccessMsg('');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/api/user/reset-password-request`, {
                email
            });
...
_s(ForgotPasswordPage, "Mae7zkABGv/Q8ExBmA1sXrL2NS8=", false, function() {
    return [
...
//# sourceMappingURL=src_app_forgotPassword_page_tsx_bc83f032._.js.map